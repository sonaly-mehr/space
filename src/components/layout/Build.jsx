    ...
    <div className="container py-10 lg:py-[70px]">
      ...
      <div className="flex flex-wrap xl:flex-nowrap justify-center xl:justify-start gap-x-0 gap-y-8 md:gap-y-16">
        {contents?.map((content, index) => (
          <div
            className="flex-layout flex-[0_1_100%] xl:flex-[0_1_33.33%] flex flex-col gap-6 items-center justify-center max-w-full"
            key={index}
          >
            <Image
              src={content?.img}
            ...
            />
            <h4 className="text-primary text-xl lg:text-[1.625rem] leading-[1.87rem] lg:leading-9 font-ztgatha font-bold -mt-[10px] xl:mt-[0]">
              {content?.heading}
            </h4>
            <p className="paragraph text-center w-full md:w-[97%] lg:w-[96%] xl:w-full lg:m-auto p-margin">
              {content?.descp}
            </p>
          </div>
        ))}
