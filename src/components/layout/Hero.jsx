...
const Hero = () => {
  return (
    <section className="bg-[#E0F2FE]">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-6 xl:gap-10">
        <div className="lg:basis-[32%]">
          ...
          <p className="font-normal text-secondary text-base lg:text-[1.25rem] leading-6 lg:leading-[2.15rem] mt-6">
